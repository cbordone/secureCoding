        ...
        try {
           ...
           // if (registeredUser == null) {
            messageSubscribe = "Thank you. Your email <em>" + email + "</em> has been accepted." +
                    "Please <a href='locations.jsp'>search</a> for the Branch Office closest to you and ask them for an account or " +
                    "if you are already registered <a href='login.jsp'>sign in</a> to use our advanced banking features";
            // } else {
